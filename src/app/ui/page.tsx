...
const typographyScale = [
  {
    label: "Eyebrow",
    className:
      "text-xs font-semibold uppercase tracking-[0.3em] text-emerald-600 dark:text-emerald-300",
    preview: "OfferCloud UI",
  },
  {
    label: "Hero h1",
    className:
      "text-4xl font-semibold tracking-tight text-zinc-900 dark:text-white sm:text-5xl sm:leading-[1.06]",
    preview:
...
const featureCards = [
  {
    ...
    icon: Newspaper,
    className: "oc-surface-subtle rounded-4xl p-7",
    iconClassName: "bg-emerald-300/10 text-emerald-700 dark:text-emerald-200",
  },
  {
    ...
    icon: Building2,
    className: "rounded-4xl border border-zinc-200 bg-white shadow-sm dark:border-white/10 dark:bg-zinc-900/70 dark:shadow-none p-7",
    iconClassName: "bg-white/6 text-emerald-700 dark:text-emerald-200",
  },
  {
    ...
    <div className="relative overflow-hidden bg-white dark:bg-zinc-950">
      <section className="relative isolate border-b border-zinc-200 dark:border-white/10">
        ...
        <div className="mx-auto max-w-6xl px-6 py-20 sm:py-28">
          ...
          <h1 className="mt-6 max-w-5xl text-4xl font-semibold tracking-tight text-zinc-900 dark:text-white sm:text-5xl sm:leading-[1.06]">
          ...
          <div className="mt-10 flex flex-col gap-4 sm:flex-row">
            ...
            <Link
              href="#komponenty"
              className="inline-flex items-center justify-center rounded-full border border-white/15 px-6 py-3.5 text-sm font-semibold text-zinc-900 dark:text-white transition hover:border-white/30 hover:bg-white/5"
            >
          ...
          <div className="mt-12 grid gap-4 md:grid-cols-4">
            {[
              ...
              <div
                key={item}
                className="rounded-3xl border border-white/10 bg-white/5 px-5 py-4 text-sm text-zinc-800 dark:text-zinc-200"
              >
                {item}
              </div>
            ))}
      ...
      >
        <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="space-y-6">
            <div className="rounded-4xl border border-zinc-200 bg-white shadow-sm dark:border-white/10 dark:bg-zinc-900/70 dark:shadow-none p-8">
            ...
            <div className="oc-surface-subtle rounded-4xl p-8">
              <p className="text-sm font-medium text-zinc-800 dark:text-zinc-200">
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                {layoutTokens.map((item) => (
                  <span
                    key={item}
                    className="rounded-full border border-white/10 px-4 py-2 text-sm text-zinc-600 dark:text-zinc-300"
                  >
                    {item}
                  </span>
                ))}
      ...
      >
        <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
          <div className="oc-surface-subtle rounded-4xl p-8">
            <p className="text-sm font-medium text-zinc-800 dark:text-zinc-200">Button set</p>
            <div className="mt-8 flex flex-wrap gap-4">
              ...
              <ContactCtaButton
                ...
                className="inline-flex items-center justify-center rounded-full bg-emerald-500 px-6 py-3.5 text-sm font-semibold text-white transition hover:bg-emerald-600 dark:bg-emerald-300 dark:text-zinc-950 dark:hover:bg-emerald-200"
              >
                Modal CTA
              </ContactCtaButton>
              <span className="inline-flex rounded-full border border-white/10 px-4 py-2 text-sm text-zinc-600 dark:text-zinc-300">
                Label / pill
              </span>
            </div>
          </div>
            ...
            <div className="mt-8 flex flex-col gap-6">
              ...
              <div className="rounded-3xl border border-white/10 bg-white/5 p-6">
                ...
                <div className="mt-4 flex flex-wrap gap-3 text-sm text-zinc-600 dark:text-zinc-300">
                  <Link href="/" className="transition hover:text-zinc-900 dark:text-white">
                    Link tekstowy
                  </Link>
                  <span className="rounded-full border border-white/10 px-3 py-1 text-[11px] text-zinc-500 dark:text-zinc-400">
                    Badge
                  </span>
                  <span className="rounded-full border border-emerald-300/20 bg-emerald-300/10 px-3 py-1 text-xs font-medium text-emerald-700 dark:text-emerald-200">
                    Accent pill
                  </span>
                </div>
              </div>
      ...
      >
        ...
        <div className="mt-12 grid gap-4 md:grid-cols-3">
          {statCards.map((item) => (
            <div key={item.value} className="oc-surface-subtle rounded-[1.75rem] p-6 transition hover:border-emerald-300/30 hover:bg-white/6">
        ...
        <div className="mt-12 grid gap-8 lg:grid-cols-[1.15fr_0.85fr]">
          <section className="oc-surface-subtle rounded-4xl p-8">
            <p className="text-sm font-medium text-zinc-800 dark:text-zinc-200">Feature split</p>
      ...
      >
        <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <h3 className="mt-6 max-w-4xl text-4xl font-semibold tracking-tight text-zinc-900 dark:text-white sm:text-5xl sm:leading-[1.04]">
            ...
            <div className="mt-10 grid gap-3 sm:grid-cols-2">
              {[
                ...
                <div
                  key={item}
                  className="rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-zinc-800 dark:text-zinc-200"
                >
                  {item}
                </div>
              ))}
          ...
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-4xl border border-white/10 bg-zinc-900/80 shadow-[0_30px_120px_rgba(0,0,0,0.45)]">
              <div className="flex items-center justify-between border-b border-zinc-200 dark:border-white/10 px-6 py-4">
                ...
                <div className="rounded-full border border-emerald-300/20 bg-emerald-300/10 px-3 py-1 text-xs font-medium text-emerald-700 dark:text-emerald-200">
                ...
                <div className="grid gap-4 lg:grid-cols-[1.2fr_0.8fr]">
                  <div className="rounded-3xl border border-white/10 bg-black/20 p-5">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="rounded-full bg-emerald-300/10 px-3 py-1 text-xs text-emerald-700 dark:text-emerald-200">
                        pod Twoja marka
                      </div>
                    </div>
                    <div className="mt-5 space-y-3">
                      {widgetRows.map((item) => (
                        <div
                          key={item}
                          className="flex items-center justify-between rounded-2xl border border-white/8 bg-white/4 px-4 py-3 text-sm text-zinc-800 dark:text-zinc-200"
                        >
                          <span>{item}</span>
        ...
        <div className="mt-12 rounded-[2.5rem] border border-white/10 bg-linear-to-br from-white/8 to-emerald-300/8 p-8 sm:p-12">
          <div className="grid gap-10 lg:grid-cols-[1fr_auto] lg:items-center">
            <div className="max-w-3xl">
              ...
              <h3 className="mt-5 text-3xl font-semibold tracking-tight text-zinc-900 dark:text-white sm:text-4xl">
      ...
      >
        <div className="rounded-[2.5rem] border border-white/10 bg-zinc-900/75 p-8 sm:p-12">
          ...
          <div className="mt-8 overflow-x-auto rounded-3xl border border-white/10 bg-zinc-950 px-5 py-4">
            <pre className="text-sm leading-7 text-zinc-600 dark:text-zinc-300">
      ...
      >
        <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
            ...
            <div className="mt-6 grid gap-5 md:grid-cols-2">
              <label className="flex flex-col gap-2 text-sm text-zinc-600 dark:text-zinc-300">
                ...
                <input
                  readOnly
                  value="Jan Kowalski"
                  className="rounded-2xl border border-white/10 bg-zinc-950 px-4 py-3 text-zinc-900 dark:text-white outline-none transition placeholder:text-zinc-500 focus:border-emerald-300/50"
                />
              </label>
              <label className="flex flex-col gap-2 text-sm text-zinc-600 dark:text-zinc-300">
                Email
              ...
              <label className="md:col-span-2 flex flex-col gap-2 text-sm text-zinc-600 dark:text-zinc-300">
                Wiadomosc
                <textarea
                  readOnly
                  rows={6}
                  value="Opis potrzeb, rynku i modelu wdrozenia."
                  className="rounded-3xl border border-white/10 bg-zinc-950 px-4 py-3 text-zinc-900 dark:text-white outline-none transition placeholder:text-zinc-500 focus:border-emerald-300/50"
                />
              </label>
            </div>
          </div>
          ...
          <div className="space-y-4">
            {faqItems.map((item) => (
              <details key={item.question} className="oc-surface-subtle group rounded-3xl px-6 py-5 open:bg-white/6">
                ...
                <p className="mt-4 max-w-3xl text-sm leading-7 text-zinc-500 dark:text-zinc-400">
                  {item.answer}
                </p>
              </details>
            ))}
      ...
      <section className="mx-auto max-w-6xl px-6 pb-16 pt-4 sm:pb-24">
        <div className="rounded-[2.5rem] border border-zinc-200 bg-white shadow-sm dark:border-white/10 dark:bg-zinc-900/70 dark:shadow-none p-8 sm:p-12">
          <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr]">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {[
                ...
                return (
                  <article key={item.title} className="oc-surface-subtle rounded-3xl p-6">
                    <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-emerald-300/10 text-emerald-700 dark:text-emerald-200">
